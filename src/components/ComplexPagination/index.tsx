...
const styles = {
	button: 'border-color text-tremor-content dark:text-dark-tremor-content bg-background hover:bg-tremor-background-muted dark:hover:bg-dark-tremor-background-muted py-2 px-3'
}
...
const ComplexPagination = ({ cursor, noMoreData, onPageChange }: ComplexPaginationProps): JSX.Element | null => {
	...
	return (
		<Grid className='gap-2' numItems={2}>
			<Button
				className={styles.button + ' rounded-lg border'}
				variant='light'
				disabled={cursor === 1}
			...
			<Flex justifyContent='center' className='rounded-lg border border-color overflow-hidden'>
				<Button
